...
def form_insert_statement(processed_feature):
    ...
    sql_statement = f"""
insert into BuildingInfo (EGID, Shape_Area, Altitude_M, RoofType, Shape_Length, Border)
VALUES (
    '{EGID}',
    '{Shape_Area}',
    '{Altitude_M}',
...
with open('../data/DC_buildings_Footprint_4326_training.geojson') as json_file:
    ...
    for feature in features:
        ...
        sql_example = form_insert_statement(processed_feature_example)
        print (sql_example)